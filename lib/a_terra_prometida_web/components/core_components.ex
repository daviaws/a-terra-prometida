defmodule ATerraPrometidaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ATerraPrometidaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ATerraPrometidaWeb.Gettext, "errors", msg, opts)
    end
  end
