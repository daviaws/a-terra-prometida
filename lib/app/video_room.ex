defmodule App.VideRoom do
  ...
  def init(room_id) do
    ...
    mock_ip = Application.fetch_env!(:app, :external_ip)
    external_ip = if @mix_env == :prod, do: {0, 0, 0, 0}, else: mock_ip
    port_range = Application.fetch_env!(:app, :port_range)
    ...
    network_options = [
      ...
      dtls_pkey: Application.get_env(:app, :dtls_pkey),
      dtls_cert: Application.get_env(:app, :dtls_cert)
    ]
